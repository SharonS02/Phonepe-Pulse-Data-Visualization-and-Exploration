...
with tab1:
    ...
    with col1:
        ...
        st.markdown("PhonePe  is an Indian digital payments and financial technology company.This helps you seamlessly process 100% online payments from your customers and is absolutely secure. ")
        st.write("****FEATURES****")
    ...
    with col2:
        st.video("C:\\Users\\manue\\Downloads\\Phone Pe Ad.mp4")
    col3,col4= st.columns(2)
    
    with col3:
        st.video("C:\\Users\\manue\\Downloads\\PhonePe Motion Graphics.mp4")
    ...
    with col6:
        st.video("C:\\Users\\manue\\Downloads\\PhonePe India's Leading Payments App.mp4")
